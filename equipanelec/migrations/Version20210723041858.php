 ...
 */
final class Version20210723041858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cable (
                        ...
                        availablemeter DOUBLE PRECISION NOT NULL, 
                        weightpermeter DOUBLE PRECISION DEFAULT NULL, 
                        purcharseprice DOUBLE PRECISION NOT NULL, 
        ...
        $this->addSql('CREATE TABLE material (
                        ...
                        saleprice DOUBLE PRECISION NOT NULL, 
                        minimumlimit DOUBLE PRECISION DEFAULT NULL, 
                        PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE movement (
                        ...
                        cables_id INT DEFAULT NULL, 
                        projects_id INT DEFAULT NULL, 
                        orderdate DATETIME NOT NULL, 
                        quantity DOUBLE PRECISION NOT NULL, 
                        INDEX IDX_F4DD95F7752C489C (tools_id), 
                        INDEX IDX_F4DD95F73A9FC940 (materials_id), 
                        INDEX IDX_F4DD95F74DE1706A (cables_id), 
                        INDEX IDX_F4DD95F71EDE0F55 (projects_id), 
                        PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE project (
                        ...
                        description LONGTEXT DEFAULT NULL,
                        advances DOUBLE PRECISION DEFAULT NULL,
                        totalcost DOUBLE PRECISION DEFAULT NULL,
                        INDEX IDX_2FB3D0EEAB014612 (clients_id),
                        PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

        $this->addSql('CREATE TABLE project_user (
                        project_id INT NOT NULL, 
                        user_id INT NOT NULL,
                        INDEX IDX_B4021E51166D1F9C (project_id), 
                        INDEX IDX_B4021E51A76ED395 (user_id), 
                        PRIMARY KEY(project_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

        $this->addSql('CREATE TABLE task (
                        id INT AUTO_INCREMENT NOT NULL,
                        name VARCHAR(100) NOT NULL, 
                        timeperminute DOUBLE PRECISION NOT NULL, 
                        description LONGTEXT DEFAULT NULL, 
                        costpertask DOUBLE PRECISION NOT NULL, 
                        PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

        $this->addSql('CREATE TABLE task_project (
                        task_id INT NOT NULL, 
                        project_id INT NOT NULL,
                        state VARCHAR(20) DEFAULT NULL,
                        observations LONGTEXT DEFAULT NULL,
                        INDEX IDX_3052FA048DB60186 (task_id), 
                        INDEX IDX_3052FA04166D1F9C (project_id), 
                        PRIMARY KEY(task_id, project_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
